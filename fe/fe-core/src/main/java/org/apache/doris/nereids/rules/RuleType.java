...
public enum RuleType {
    ...
    COLUMN_PRUNE_SCAN(RuleTypeClass.REWRITE),
    COLUMN_PRUNE_FILTER(RuleTypeClass.REWRITE),
    COLUMN_PRUNE_JOIN(RuleTypeClass.REWRITE),
    COLUMN_PRUNE_JOIN_CHILDREN(RuleTypeClass.REWRITE),
    COLUMN_PRUNE_AGGREGATION(RuleTypeClass.REWRITE),
    COLUMN_PRUNE_AGGREGATION_CHILDREN(RuleTypeClass.REWRITE),


    REWRITE_SENTINEL(RuleTypeClass.REWRITE),
    MERGE_PROJECTION_INTO_CHILD(RuleTypeClass.REWRITE),
    PUSH_DOWN_PREDICATE_INTO_SCAN(RuleTypeClass.REWRITE),
