...
public enum RuleType {
    ...
    BINDING_QUALIFY_SLOT(RuleTypeClass.REWRITE),
    ...
    FILL_UP_QUALIFY_AGGREGATE_AGGREGATE(RuleTypeClass.REWRITE),
    FILL_UP_QUALIFY_AGGREGATE_HAVING_AGGREGATE(RuleTypeClass.REWRITE),
